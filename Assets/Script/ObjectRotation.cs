...
public class ObjectRotation : MonoBehaviour
{
    ...
    //public bool InvertedV;
    //public bool LimitedV;
    public bool istouchpadactive = true;
    ...
    void FixedUpdate()
    {
        if (istouchpadactive)
        {
            ...
            if (RotatableH != null)
            {
                RotatableH.transform.Rotate(0f, mouseDeltaPosition.x * (RotationSpeed * -1), 0f);
            }
            if (RotatableV != null)
            {
                RotatableV.transform.Rotate(mouseDeltaPosition.y * (RotationSpeed * -1), 0f, 0f);
